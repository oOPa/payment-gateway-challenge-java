...
public class PaymentGatewayController {
  ...
  @PostMapping("/payment")
  public ResponseEntity<PostPaymentResponse> postPostPaymentEvent(@RequestBody PostPaymentRequest postPaymentRequest) {
    PostPaymentResponse postPaymentResponse = paymentGatewayService.processPayment(postPaymentRequest);

    if (postPaymentResponse.getStatus().equals(PaymentStatus.REJECTED)) {
